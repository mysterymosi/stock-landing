const { sendJSONResponse, validatePassword } = require('../../helpers');
...
exports.get2FA = async function (req, res) {
    ...
    verificationRequest = await twilio.verify.services(VERIFICATION_SID)
        ...
        .create({
            ...
            }, to: req.body.mobileNumber, channel, customFriendlyName: "Token from StockTrade"
        });
...
module.exports.updatePassword = async (req, res) => {
    ...
    const userIsRegistered = req.user
